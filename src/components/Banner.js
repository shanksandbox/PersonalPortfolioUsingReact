          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hey! I'm Prakhar,`} <span className="txt-rotate" dataPeriod="500" data-rotate='["Android Developer", "Web Developer", "Student" ]'><span className="wrap">{text}</span></span></h1>
                <p>Hi,I am Prakhar Singh. I'm a pre-final B.Tech student at the GL Bajaj Institute of Technology & Management.
